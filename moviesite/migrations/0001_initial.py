    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "movie_trailer",
                    models.FileField(blank=True, null=True, upload_to="trailer"),
                ),
                ...
                (
                    "actor",
                    models.ManyToManyField(
                        related_name="movie_actor", to="moviesite.actor"
                    ),
                ),
                (
                    "country",
                    models.ForeignKey(
                        ...
                        to="moviesite.country",
                    ),
                ),
                (
                    "director",
                    models.ManyToManyField(
                        related_name="movie_director", to="moviesite.director"
                    ),
                ),
                (
                    "genre",
                    models.ManyToManyField(
                        related_name="movie_genre", to="moviesite.genre"
                    ),
                ),
                ("movie", models.ManyToManyField(to="moviesite.movielanguages")),
            ],
        ),
        migrations.CreateModel(
            name="Moment",
